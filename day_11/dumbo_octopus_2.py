...
x_len = len(matrix[0])
flashing_events = 0
condition_sync_flash = False
steps = 0

while (not condition_sync_flash):
    condition_sync_flash = check_sync_flash(matrix)
    if(condition_sync_flash):
        break
